...
transverse field Ising model and antiferromagnetic Heisenberg model (carleo solving 2017). Such models are motivated by the 
...
atoms and small molecules (hermann deep-neural-network 2020, pfau ab 2020, Pescia 2022). \\
...
every aspect of the work included in this report is already implemented in a more comprehensive way (Vicentini 2022).
